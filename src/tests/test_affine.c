 ...
 * Edit the original source file "tests/test_affine.check" instead.
 */
...
int main(void)
{
    ...
    tcase_add_test(tc1_1, move_x_1);
    tcase_add_test(tc1_1, move_y_1);
    tcase_add_test(tc1_1, move_z_1);
    tcase_add_test(tc1_1, deg_to_rad_1);
    tcase_add_test(tc1_1, rotate_x);
    tcase_add_test(tc1_1, rotate_z);
    tcase_add_test(tc1_1, rotate_y);
    tcase_add_test(tc1_1, scale_1);
    tcase_add_test(tc1_1, read_count_1);
    tcase_add_test(tc1_1, read_data_1);
